      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          {activeThemeId && (
            <button
              onClick={handleReset}
              className="px-4 py-2 text-sm font-medium text-blue-600 bg-gray-200 rounded-lg hover:bg-gray-300"
            >
              Reset Selection
            </button>
          )}
          ...
          {themes.map((theme) => (
            ...
            >
              <div className="p-6">
                ...
                <p className="text-sm text-blue-600 mb-4">{theme.description}</p>
