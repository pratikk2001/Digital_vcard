      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className="p-3 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 ease-in-out"
            placeholder="तुमचा फोन नंबर प्रविष्ट करा"
            required
          />
        </div>
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            value={formData.dob}
            onChange={handleInputChange}
            aria-label="mm/dd/yyyy (हे फॉर्मॅट इंग्रजीतच ठेवले कारण हे आंतरराष्ट्रीय प्रारूप आहे)"
            className="p-3 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 ease-in-out"
            required
          />
        </div>
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className="p-3 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 ease-in-out"
            placeholder="तुमचे पद शीर्षक प्रविष्ट करा"
            required
          />
        </div>
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className="p-3 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 ease-in-out"
            placeholder="तुमचे शिक्षण प्रविष्ट करा"
            required
          />
        </div>
