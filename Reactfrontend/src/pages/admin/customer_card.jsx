...
<div>
  <TopNavbar />
  <div className="bg-blue-50 min-h-screen flex flex-col md:flex-row items-center md:items-start p-5">
    <Sidenav />
    <div className="w-full max-w-6xl bg-white shadow-lg rounded-lg overflow-x-auto">
