...
const uploadElectronicNewsImages = require("../../middlewares/uploadElectronicNews"); // Import the multer config
...
router.post("/save/profileBanner/:id", uploadProfilePictureBanner.fields([{ name: "profilePicture", maxCount: 1 },
...
router.post("/save/electronicNewsCenterImages/:id",uploadElectronicNewsImages.array("electroniNews",5), TemplateController.saveElectronicNewsImages);

router.post("/save/youtubeLinks/:id", TemplateController.saveYoutubeLinks);
...
router.get("/getElectronicNewsImage/:imageId", TemplateController.getElectronicNewsImage);


// getElectronicNewsImage
